...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for action in legal_actions: 
            q_value = self.getQValue(state, action) # get Q(s, a)
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.q_values[(state, action)] = (1 - self.alpha) * old_q + self.alpha * target
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        # compute the dot product between weights and faeaturs
        q_value = 0.0 
    ...
    def update(self, state, action, nextState, reward):
        ...
        next_value = self.computeValueFromQValues(nextState)
        # grab the difference error
        difference = (reward + self.discount * next_value) - current_q
        features = self. featExtractor.getFeatures(state, action)
        # update weight based on feature
        for feature, value in features.items():
